...
def Menu():
    if request.form :
       ...
       for i in range(nbre_monstre):
           ...
           liste_monsrtres.append(nom_monstre)

       liste_pseudo = [pseudo,nbre_monstre]
       return render_template('index.html',pseudo=pseudo,nbre_monstre=nbre_monstre,liste_pseudo=liste_pseudo,liste_monsrtres=liste_monsrtres)
    else:
